  ...
  head: {
    ...
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "mua sắm nhận hoàn tiền, mua hàng online, hoàn tiền, nhận hoàn tiền, so sánh giá, xem giá tốt, mã giảm giá, giảm giá, chiết khấu, mã voucher, cash back"
      },
      {
        hid: "description",
        name: "description",
      ...
      },
      {
        ...
        property: "image",
        content:
          "https://d604u3cjqmj8m.cloudfront.net/resources/images/img-thumb-default.jpg"
      },
      {
        hid: "og:url",
        property: "og:url",
    ...
    script: [
      ...
      {
        src:
          "https://www.googletagmanager.com/gtag/js?id=AW-613926557"
      },
      {
        hid: "gtmHead",
