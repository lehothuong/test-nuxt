<template>
  <section :class="{'d-none':!bannerHomeChild}" class="mt-lg-5 mt-4">
    <div class="container">
      <div class="flex-row d-flex">
        <img
          class="iconChild"
          alt="goCASHBACK"
          src="../../assets/img/icon/icon_baby.svg"
          width="20"
          height="20"
        />
        <h5 class="titleHot titleChildColor titleChild ml-lg-2 pl-lg-1 pl-2">deal hot dành cho con</h5>
      </div>
      <div class="row mx-2-minus" v-if="!bannerHomeChild">
        <div class="col-lg-6 mt-lg-3 mt-10-res px-lg-2" v-for="(item, index) in 4" :key="index">
      ...
      <div
        class="growAll"
        :class="
          bannerHomeChild && bannerHomeChild.length > 4
            ? 'bannerChildHeight'
            : ''
        "
        id="bannerChildBox-1"
        v-else
      >
        <div class="row mx-2-minus subBannerChild-1">
          <div
            class="col-lg-6 mt-lg-3 mt-10-res px-lg-2"
            v-for="(item, index) in bannerHomeChild"
            :key="'a' + index"
          >
            <a
              class="pointer boxBannerChild"
      ...
      <div class="text-center" v-if="bannerHomeChild && bannerHomeChild.length > 4">
